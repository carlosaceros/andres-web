            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                    <div className="lg:col-span-3">
                            ...
                            <div className="grid grid-cols-2">
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0">
                                        <div
                                            ...
                                            style={{ background: 'linear-gradient(to top, rgba(234, 88, 12, 0.85) 0%, rgba(249, 115, 22, 0.6) 40%, rgba(251, 146, 60, 0.3) 70%, rgba(0, 0, 0, 0) 100%)' }}
                                        >
                                ...
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0">
                                        <div
                                            className="text-white p-4 rounded-b-lg"
                                            style={{ background: 'linear-gradient(to top, rgba(220, 38, 38, 0.85) 0%, rgba(248, 113, 113, 0.6) 40%, rgba(252, 165, 165, 0.3) 70%, rgba(0, 0, 0, 0) 100%)' }}
                                        >
                                            <p className="font-medium text-lg">{currentImagePair.view}</p>
                        ...
                        <div className="mt-6">
                            <h1 className="text-3xl font-bold text-gray-800 mb-3">Pexia - Elevación de Senos</h1>
                                        ...
                                        >
                                            <div className="grid grid-cols-2 gap-0.5">
                                                <div className="w-full h-24 relative">
                                                    ...
                                                    <div className="absolute top-1 left-1"><span className="text-white text-xs font-bold bg-orange-600 bg-opacity-90 px-1 py-0.5 rounded">A</span></div>
                                                </div>
                                                <div className="w-full h-24 relative">
                                                    <img src={image.after} alt={`${image.view} - Después`} className="w-full h-full object-cover rounded-tr-lg" />
                                                    <div className="absolute top-1 right-1"><span className="text-white text-xs font-bold bg-red-600 bg-opacity-90 px-1 py-0.5 rounded">D</span></div>
                                                </div>
                                            </div>
                                        </button>
                                    ))}
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-2xl font-bold text-gray-800">Todos los Pacientes de Pexia - Elevación de Senos</h2>
                    </div>
                                    ...
                                    <div key={patientName} className="flex-shrink-0">
                                        ...
                                        >
                                            <div className={`bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all border-2 w-32 ${selectedPatient === patientName ? 'border-orange-500 ring-2 ring-orange-200' : 'border-gray-200'}`}>
                                                <div className="grid grid-cols-2">
                                                    <div className="w-full h-40 relative"><img src={firstImage.before} alt="Antes" className="w-full h-full object-cover" /><div className="absolute top-1 left-1"><span className="text-white text-xs font-bold bg-orange-600 px-2 py-1 rounded">A</span></div></div>
                                                    <div className="w-full h-40 relative"><img src={firstImage.after} alt="Después" className="w-full h-full object-cover" /><div className="absolute top-1 right-1"><span className="text-white text-xs font-bold bg-red-600 px-2 py-1 rounded">D</span></div></div>
                                                </div>

...
export default function BlefaroplastiaClientContent() {
  ...
  return (
    <main className="min-h-screen">
                ...
                <div className="aspect-[4/6] bg-gray-200 rounded-lg overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div
                      ...
                      style={{
                        background: 'linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(29, 60, 93, 0.53) 30%, rgba(29, 60, 93, 0.73) 70%, rgba(29, 60, 93, 0.8) 100%)'
                      }}
                    >
      ...
      <section className="py-16 text-white" style={{ background: 'radial-gradient(ellipse at center, #2c5aa0 0%, #1d3c5d 70%, #1a3a5a 100%)' }}>
        <div className="container mx-auto px-4">
          <div className="text-left mb-16">
            <h2 className="font-prototype text-3xl lg:text-4xl font-normal mb-4">{t('fat_sliding_title')}</h2>
            <div className="w-79 h-1 bg-white mb-6 ml-0"></div>
            <h3 className="font-sansation text-xl lg:text-2xl font-bold mb-8">{t('fat_sliding_subtitle')}</h3>
          </div>
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              <p className="font-sansation font-normal text-lg leading-relaxed">{t('fat_sliding_p1')}</p>
            </div>
          </div>
          <div>
            <h3 className="font-prototype text-3xl lg:text-4xl font-normal text-center mb-12">{t('why_different_title')}</h3>
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="p-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#babdb3', minHeight: '350px', maxWidth: '280px', margin: '0 auto' }}>
                <p className="font-sansation font-normal leading-relaxed text-center" style={{ color: '#1d3c5d' }}>{t('why_different_c1')}</p>
              </div>
              <div className="p-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#babdb3', minHeight: '350px', maxWidth: '280px', margin: '0 auto' }}>
                <p className="font-sansation font-normal leading-relaxed text-center" style={{ color: '#1d3c5d' }}>{t('why_different_c2')}</p>
              </div>
              <div className="p-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#babdb3', minHeight: '350px', maxWidth: '280px', margin: '0 auto' }}>
                <p className="font-sansation font-normal leading-relaxed text-center" style={{ color: '#1d3c5d' }}>{t('why_different_c3')}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="font-prototype text-3xl lg:text-4xl font-normal text-left mb-4" style={{ color: '#1d3c5d' }}>{t('results_title')}</h2>
          ...
          <div className="text-center mt-8 mb-18">
            ...
            >
              <span className="font-sansation font-semibold text-lg mr-3">{t('view_more_cases')}</span>
              <svg className="w-5 h-5 transform group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5-5 5M6 12h12" />
              </svg>
            </Link>
          </div>
          <h2 className="font-prototype text-3xl lg:text-4xl font-normal mb-4" style={{ color: '#1d3c5d' }}>{t('testimonials_title')}</h2>
          ...
          <div className="text-center">
            <Link href={`/${locale}/testimonios`}>
              <button
                className="font-sansation font-bold px-8 py-3 rounded-full transition-colors border-2 hover:bg-white hover:text-gray-800"
                style={{ borderColor: '#1d3c5d', color: '#1d3c5d' }}
              >
                {t('view_more_button')}
              </button>

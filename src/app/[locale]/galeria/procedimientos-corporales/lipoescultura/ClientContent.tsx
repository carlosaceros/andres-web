...
export default function ClientContent() {
    ...
    const procedureImages: ProcedureImage[] = [
        {
            before: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente1FrenteAntes.webp",
            after: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente1FrenteDespues.webp",
            view: "Paciente 1 - Frontal",
            patient: "Paciente 1",
        },
        {
            before: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente1LadoAntes.webp",
            after: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente1LadoDespues.webp",
            view: "Paciente 1 - Perfil",
            patient: "Paciente 1",
        },
        {
            before: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente2FrenteAntes.webp",
            after: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente2FrenteDespues.webp",
            view: "Paciente 2 - Frontal",
            patient: "Paciente 2",
        },
        {
            before: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente2LadoAntes.webp",
            after: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente2LadoDespues.webp",
            view: "Paciente 2 - Perfil",
            patient: "Paciente 2",
        },
        {
            before: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente2EspaldaAntes.webp",
            after: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente2EspaldaDespues.webp",
            view: "Paciente 2 - Perfil",
            patient: "Paciente 2",
        },
        {
            before: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente3FrenteAntes.webp",
            after: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente3FrenteDespues.webp",
            view: "Paciente 3 - Frontal",
            patient: "Paciente 3",
        },
        {
            before: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente3LadoAntes.webp",
            after: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente3LadoDespues.webp",
            view: "Paciente 3 - Perfil",
            patient: "Paciente 3",
        },
        {
            before: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente3EspaldaAntes.webp",
            after: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente3EspaldaDespues.webp",
            view: "Paciente 3 - Perfil",
            patient: "Paciente 3",
        },
        {
            before: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente4Antes.webp",
            after: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente4Despues.webp",
            view: "Paciente 4 - Frontal",
            patient: "Paciente 4",
        },
        {
            before: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente5Antes.webp",
            after: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente5Despues.webp",
            view: "Paciente 5 - Frontal",
            patient: "Paciente 5",
        },
        {
            before: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente6Antes.webp",
            after: "https://media.drandrespereznieto.com/images/todos/Lipoescultura/Paciente6Antes.webp",
            view: "Paciente 6 - Frontal",
            patient: "Paciente 6",
            description: "Contorno corporal con técnica especializada"
        },
    ];
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                    <div className="lg:col-span-3">
                            ...
                            <div className="grid grid-cols-2">
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0">
                                        <div
                                            ...
                                            style={{ background: 'linear-gradient(to top, rgba(124, 58, 237, 0.85) 0%, rgba(147, 51, 234, 0.6) 40%, rgba(168, 85, 247, 0.3) 70%, rgba(0, 0, 0, 0) 100%)' }}
                                        >
                                ...
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0">
                                        <div
                                            className="text-white p-4 rounded-b-lg"
                                            style={{ background: 'linear-gradient(to top, rgba(236, 72, 153, 0.85) 0%, rgba(244, 114, 182, 0.6) 40%, rgba(251, 182, 206, 0.3) 70%, rgba(0, 0, 0, 0) 100%)' }}
                                        >
                                            <p className="font-medium text-lg">{currentImagePair.view}</p>
                        ...
                        <div className="mt-6">
                            <h1 className="text-3xl font-bold text-gray-800 mb-3">Lipoescultura</h1>
                                        ...
                                        >
                                            <div className="grid grid-cols-2 gap-0.5">
                                                <div className="w-full h-24 relative">
                                                    ...
                                                    <div className="absolute top-1 left-1"><span className="text-white text-xs font-bold bg-purple-600 bg-opacity-90 px-1 py-0.5 rounded">A</span></div>
                                                </div>
                                                <div className="w-full h-24 relative">
                                                    <img src={image.after} alt={`${image.view} - Después`} className="w-full h-full object-cover rounded-tr-lg" />
                                                    <div className="absolute top-1 right-1"><span className="text-white text-xs font-bold bg-pink-600 bg-opacity-90 px-1 py-0.5 rounded">D</span></div>
                                                </div>
                                            </div>
                                        </button>
                                    ))}
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-2xl font-bold text-gray-800">Todos los Pacientes de Lipoescultura</h2>
                    </div>
                                        ...
                                        >
                                            <div className={`bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all border-2 w-32 ${selectedPatient === patientName ? 'border-purple-500 ring-2 ring-purple-200' : 'border-gray-200'}`}>
                                                <div className="grid grid-cols-2">
                                                    ...
                                                    <div className="w-full h-40 relative"><img src={firstImage.after} alt="Después" className="w-full h-full object-cover" /><div className="absolute top-1 right-1"><span className="text-white text-xs font-bold bg-pink-600 px-2 py-1 rounded">D</span></div></div>
                                                </div>
